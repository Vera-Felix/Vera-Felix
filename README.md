...
* Linguagens de Programação que estou estudando: Python, SQL

* Ferramentas e Tecnologias que me interessam: Excel, Power BI, MySQL, VSCode

* Interesses: Ciência de Dados, Análise de Dados e Machine Learning

#### Objetivos ao Terminar o Curso ✔️
Meu objetivo ao concluir o Bootcamp de Python para Dados é garantir uma posição como analista de dados que não só me proporcione um salário digno, mas também me ofereça desafios intelectuais e a oportunidade de aplicar minhas habilidades para resolver problemas reais. Quero encontrar uma empresa onde eu possa crescer profissionalmente e contribuir para projetos significativos, sempre buscando a satisfação pessoal e a realização profissional em tudo o que faço.
